...
OUT = (
    ...
    "timing71_legacy_attempt_reconstruction_v3"
)
...
PARENTS_OUT = (
    OUT /
    "legacy_parent_objects_v3.csv"
)

CAND_OUT = (
    OUT /
    "legacy_fourlap_candidates_v3.csv"
)

MATCH_OUT = (
    OUT /
    "legacy_official_attempt_matches_global_v3.csv"
)

COVERAGE_OUT = (
    OUT /
    "legacy_official_coverage_audit_v3.csv"
)

SUMMARY_OUT = (
    OUT /
    "legacy_match_summary_v3.csv"
)

TRANS_OUT = (
    OUT /
    "legacy_verified_repeat_transitions_v3.csv"
)
...
print(
    "\nR6_LEGACY_TIMING71_ATTEMPT_RECONSTRUCTION_V3_COMPLETE"
)
