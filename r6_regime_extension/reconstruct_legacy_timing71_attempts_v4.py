...
OFFICIAL = (
    ...
    "regime_official_attempt_inventory_v4.csv"
)

OUT = (
    ROOT /
    "r6_regime_extension/output/"
    "timing71_legacy_attempt_reconstruction_v4"
)
...
PARENTS_OUT = (
    OUT /
    "legacy_parent_objects_v4.csv"
)

CAND_OUT = (
    OUT /
    "legacy_fourlap_candidates_v4.csv"
)

MATCH_OUT = (
    OUT /
    "legacy_official_attempt_matches_global_v4.csv"
)

COVERAGE_OUT = (
    OUT /
    "legacy_official_coverage_audit_v4.csv"
)

SUMMARY_OUT = (
    OUT /
    "legacy_match_summary_v4.csv"
)

TRANS_OUT = (
    OUT /
    "legacy_verified_repeat_transitions_v4.csv"
)
...
print(
    "\nR6_LEGACY_TIMING71_ATTEMPT_RECONSTRUCTION_V4_COMPLETE"
)
