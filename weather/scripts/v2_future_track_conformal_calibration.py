...
SUMMARY_FILE = (
    OUTPUT_DIR
    / "future_track_conformal_calibration_v1.txt"
)
...
def main():
    ...
    print("=" * 72)
    print(
        "INDY 500 V2-A HORIZON-SPECIFIC CONFORMAL CALIBRATION"
    )
    print("=" * 72)
    ...
    add("=" * 72)
    add("OVERALL CONFORMAL COVERAGE")
    add("=" * 72)
    add()
    add(
        overall
